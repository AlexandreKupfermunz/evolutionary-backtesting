...
def run_walk_forward(df, windows, number_of_generations, population_size, fitness_function, tick_value, commission, maximum_holding_bars, patience):
    ...
    for window in windows:
        ...
        generation_results.append(GenerationResult(
                                        ...
                                        gross_profit=gross_profit(original_trades, tick_value),
                                        gross_loss=gross_loss(original_trades, tick_value),
                                        profit_factor=profit_factor(original_trades, tick_value),
                                        max_drawdown=max_drawdown(original_trades, tick_value, commission),
                                        win_rate=win_rate(original_trades),
                                        ...
                                        biggest_losing_streak=biggest_losing_streak(original_trades),
                                        patience_counter=0
                                    ))
        ...
        for i in range(1, number_of_generations):
            ...
            generation_results.append(GenerationResult(
                                        ...
                                        gross_profit=gross_profit(best_train_trades, tick_value),
                                        gross_loss=gross_loss(best_train_trades, tick_value),
                                        profit_factor=profit_factor(best_train_trades, tick_value),
                                        max_drawdown=max_drawdown(best_train_trades, tick_value, commission),
                                        win_rate=win_rate(best_train_trades),
                                        ...
                                        biggest_losing_streak=biggest_losing_streak(best_train_trades),
