...
walk_forward_df = load_all_csvs(results_folder, "walk_forward_results.csv")
...
filtered_train_df = generation_train_df[
    ...
    (generation_train_df["fitness_function"] == "balanced_fitness") &
...
filtered_test_df = generation_test_df[
    ...
    (generation_test_df["fitness_function"] == "balanced_fitness") &
